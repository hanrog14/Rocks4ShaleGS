...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({name: 'Granite', description: `A coarse-grained, light-colored, intrusive rock that contains mainly quartz, feldspar, and mica minerals. This is a 10" by 12" slab.`, price: 16.13, inventory: 43, category: 'Igneous', pictureUrl: 'https://geology.com/rocks/pictures/granite.jpg'}),
    ...
    Product.create({name: 'Soapstone', description: `A metamorphic rock that consists primarily of talc with varying amounts of other minerals such as micas, chlorite, amphiboles, pyroxenes, and carbonates. It is a soft, dense, heat-resistant rock that has a high specific heat capacity. These properties make it useful for a wide variety of architectural, practical, and artistic uses. This is a 10" by 12" slab.`, price: 13.99, inventory: 55, category: 'Metamorphic', pictureUrl: 'https://geology.com/rocks/pictures/soapstone.jpg'}),
    ...
    Product.create({name: 'Rock Salt', description: `A chemical sedimentary rock that forms from the evaporation of ocean or saline lake waters. It is also known by the mineral name "halite." It is rarely found at Earth's surface, except in areas of very arid climate. It is often mined for use in the chemical industry or for use as a winter highway treatment. Some halite is processed for use as a seasoning for food. This is a 10" by 12" slab.`, price: 4.99, inventory: 114, category: 'Sedimentary', pictureUrl: 'https://geology.com/rocks/pictures/rock-salt.jpg'}),
