...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({name: 'Granite', description: `A coarse-grained, light-colored, intrusive rock that contains mainly quartz, feldspar, and mica minerals. This is a 10" by 12" slab.`, price: 16.13, inventory: 43, category: 'Igneous', pictureUrl: 'https://geology.com/rocks/pictures/granite-coarse-grained-380.jpg'}),
